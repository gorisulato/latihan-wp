...
if ( $cross_sells ) : ?>
	...
	<div class="cross-sells">
		...
		<h3 class="uk-h4">
			<?php if( !empty( $WooSinglecrosssellsTitle ) ):?>
				<?php echo apply_filters( 'dahz_framework_cross_sells_title', $WooSinglecrosssellsTitle );?>
			<?php else:?>
				<?php esc_html_e( 'You may be interested in&hellip;', 'baklon' ) ?>
			<?php endif;?>
		</h3>
