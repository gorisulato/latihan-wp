		...
		<div class="<?php echo esc_attr( $builder_class ); ?>__wrapper-tooltip">
			<span class="<?php echo esc_attr( $builder_class ); ?>__wrapper-title">
				<span class="<?php echo esc_attr( $builder_class ); ?>__wrapper-default-preset-title">
					<?php printf( esc_html__( '%s Builder', 'baklon' ), $builder_title ); ?>
				</span>
			</span>
			<span class="<?php echo esc_attr( $builder_class ); ?>__wrapper-preview">
				<a class="<?php echo esc_attr( $builder_class ); ?>__wrapper-preview-action" data-trigger="preview-desktop"><?php esc_attr_e( 'Desktop', 'baklon' ); ?></a>
				<a class="<?php echo esc_attr( $builder_class ); ?>__wrapper-preview-action" data-trigger="preview-mobile"><?php esc_attr_e( 'Tablet/Mobile', 'baklon' ); ?></a>
			</span>
			<span class="<?php echo esc_attr( $builder_class ); ?>__wrapper-right">
				<a class="<?php echo esc_attr( $builder_class ); ?>__wrapper-default"><?php echo esc_html__( 'Set as Default', 'baklon' ); ?></a>
				<a class="<?php echo esc_attr( $builder_class ); ?>__wrapper-default-set"><?php echo esc_html__( 'Default Preset', 'baklon' ); ?></a>
				<a class="<?php echo esc_attr( $builder_class ); ?>__wrapper-open-container"><?php echo esc_html__( 'Save Preset', 'baklon' ); ?></a>
				<a class="<?php echo esc_attr( $builder_class ); ?>__wrapper-default-cancel"><?php echo esc_html__( 'Cancel Edit', 'baklon' ); ?></a>
				<div class="<?php echo esc_attr( $builder_class ); ?>__wrapper-preset-container">
					<div class="<?php echo esc_attr( $builder_class ); ?>__wrapper-preset-container-inner-wrapper">
						<span class="<?php echo esc_attr( $builder_class ); ?>__wrapper-preset-title">
							<?php echo esc_html__( 'Save Header as Preset', 'baklon' ); ?>
						...
						<div class="<?php echo esc_attr( $builder_class ); ?>__wrapper-preset-container-save">
							<p><?php echo esc_html__( 'Save current layout as a template', 'baklon' ); ?></p>
								...
								<?php
									if ( DAHZ_FRAMEWORK_DEVELOP_MODE ) {
										printf(
											...
											esc_html__( 'Preset Category ID', 'baklon' ),
											esc_attr__( 'Preset Category ID', 'baklon' ),

											esc_html__( 'Preset Category Name', 'baklon' ),
											esc_attr__( 'Preset Category Name', 'baklon' ),

											esc_html__( 'Preset Title', 'baklon' ),
											esc_attr__( 'Preset Title', 'baklon' ),

											esc_html__( 'Preset Image ( Notes : put only image name and images file must be exist in directory "baklon/dahz-framework/admin/customizer/presets/images/" )', 'baklon' ),
											esc_attr__( 'Preset Image', 'baklon' )

										);
									}
								?>
								<p><?php echo esc_html__( 'Save layout and reuse it on different sections of this site', 'baklon' ); ?></p>
							</div>
						</div>
						<div class="<?php echo esc_attr( $builder_class ); ?>__wrapper-preset-container-edit">
							<p><?php echo esc_html__( 'Are you sure want to change preset?', 'baklon' ); ?></p>
						</div>
						<a class="<?php echo esc_attr( $builder_class ); ?>__wrapper-save"><?php echo esc_html__( 'Save Preset', 'baklon' ); ?></a>
					</div>
				</div>
		...
		<div class="<?php echo esc_attr( $builder_class ); ?> <?php echo esc_attr( $builder_class ); ?>__builder">
					...
					?>
						<div class="<?php echo esc_attr( $builder_class ); ?>__inner <?php echo esc_attr( $builder_class ); ?>__section" data-section-<?php echo esc_attr( $builder_type ); ?>="<?php echo esc_attr( $sectionID ); ?>">
							<div class="<?php echo esc_attr( $builder_class ); ?>__tooltip">
								<p><?php echo esc_html__( 'Section ', 'baklon' ) . $i?></p>
			...
			<div class="<?php echo esc_attr( $builder_class ); ?>__element-storage">
				<div class="<?php echo esc_attr( $builder_class ); ?>__wrapper-tooltip">
					<span class="<?php echo esc_attr( $builder_class ); ?>__wrapper-title">
						<span class="<?php echo esc_attr( $builder_class ); ?>__wrapper-default-preset-title">
							<?php printf( esc_html__( '%s Element', 'baklon' ), $builder_type ); ?>
						</span>
					</span>
			...
			<div class="<?php echo esc_attr( $builder_class ); ?>__column-edit-container">
				<div class="<?php echo esc_attr( $builder_class ); ?>__column-edit-container-inner-wrapper">
					<span class="<?php echo esc_attr( $builder_class ); ?>__column-edit-title">
						<?php echo esc_html__( 'Edit Column', 'baklon' ); ?>
					...
					<p><?php echo esc_html__( 'Alignment', 'baklon' ); ?></p>
					<div class="<?php echo esc_attr( $builder_class ); ?>__column-edit-container-inner">
						<select id="de-<?php echo esc_attr( $builder_type ); ?>-builder-column-alignment">
							<option value="flex-start"><?php esc_html_e( 'Left', 'baklon' ); ?></option>
							<option value="flex-center"><?php esc_html_e( 'Center', 'baklon' ); ?></option>
							<option value="flex-end"><?php esc_html_e( 'Right', 'baklon' ); ?></option>
						</select>
					</div>
					<p><?php echo esc_html__( 'Extra class name', 'baklon' ); ?></p>
					<div class="<?php echo esc_attr( $builder_class ); ?>__column-edit-container-inner">
						<input type="text" id="de-<?php echo esc_attr( $builder_type ); ?>-builder-column-extraclass" />
						<p><?php echo esc_html__( 'Adding extra class', 'baklon' ); ?></p>
					</div>
					<div class="<?php echo esc_attr( $builder_class ); ?>__column-edit-container-section2-vertical">
						<p><?php echo esc_html__( 'Padding Top', 'baklon' ); ?></p>
						<div class="<?php echo esc_attr( $builder_class ); ?>__column-edit-container-inner">
							<input type="text" id="de-<?php echo esc_attr( $builder_type ); ?>-builder-column-padding-top" />
							<p><?php echo esc_html__( 'Adding Padding Top', 'baklon' ); ?></p>
						</div>
						<p><?php echo esc_html__( 'Padding Bottom', 'baklon' ); ?></p>
						<div class="<?php echo esc_attr( $builder_class ); ?>__column-edit-container-inner">
							<input type="text" id="de-<?php echo esc_attr( $builder_type ); ?>-builder-column-padding-bottom" />
							<p><?php echo esc_html__( 'Adding Padding Bottom', 'baklon' ); ?></p>
						</div>
					</div>
					<a class="<?php echo esc_attr( $builder_class ); ?>__column-edit-save"><?php echo esc_html__( 'Save', 'baklon' ); ?></a>
				</div>
			</div>
			<div class="<?php echo esc_attr( $builder_class ); ?>__custom-row-edit-container">
				<div class="<?php echo esc_attr( $builder_class ); ?>__custom-row-edit-container-inner-wrapper">
					<span class="<?php echo esc_attr( $builder_class ); ?>__custom-row-edit-title">
						<?php echo esc_html__( 'Custom Row', 'baklon' ); ?>
					...
					<p><?php echo esc_html__( 'Custom Row', 'baklon' ); ?></p>
					<div class="<?php echo esc_attr( $builder_class ); ?>__custom-row-edit-container-inner">
						...
						<p><?php echo esc_html__( 'example : 1/2+1/2', 'baklon' ); ?></p>
					</div>
					<a class="<?php echo esc_attr( $builder_class ); ?>__custom-row-edit-save"><?php echo esc_html__( 'Save', 'baklon' ); ?></a>
				</div>
			</div>
		</div>
		<div class="<?php echo esc_attr( $builder_class ); ?>__wrapper-tooltip">
			<span class="<?php echo esc_attr( $builder_class ); ?>__wrapper-title">
				<span class="<?php echo esc_attr( $builder_class ); ?>__wrapper-default-preset-title--borderless">
					<?php printf( esc_html__( '%s Preset', 'baklon' ), $builder_title ); ?>
				</span>
			</span>
			<a class="<?php echo esc_attr( $builder_class ); ?>__wrapper-icon">
				<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 490 490" style="enable-background:new 0 0 490 490;" xml:space="preserve">
