...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args( $this->button_labels,
			array(
				'select'       => esc_attr__( 'Select image', 'baklon' ),
				'change'       => esc_attr__( 'Change image', 'baklon' ),
				'default'      => esc_attr__( 'Default', 'baklon' ),
				'remove'       => esc_attr__( 'Remove', 'baklon' ),
				'placeholder'  => esc_attr__( 'No image selected', 'baklon' ),
				'frame_title'  => esc_attr__( 'Select image', 'baklon' ),
				'frame_button' => esc_attr__( 'Choose image', 'baklon' ),
			)
		);
	}
