...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'baklon' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'baklon' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'baklon' ),
			'200'       => esc_attr__( 'Light 200', 'baklon' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'baklon' ),
			'300'       => esc_attr__( 'Book 300', 'baklon' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'baklon' ),
			'400'       => esc_attr__( 'Normal 400', 'baklon' ),
			'regular'   => esc_attr__( 'Normal 400', 'baklon' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'baklon' ),
			'500'       => esc_attr__( 'Medium 500', 'baklon' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'baklon' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'baklon' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'baklon' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'baklon' ),
			'700'       => esc_attr__( 'Bold 700', 'baklon' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'baklon' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'baklon' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'baklon' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'baklon' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'baklon' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'baklon' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'baklon' ),
		);
	}
