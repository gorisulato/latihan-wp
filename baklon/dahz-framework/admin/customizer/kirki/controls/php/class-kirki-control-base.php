	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_attr__( 'No File Selected', 'baklon' ),
				'remove'               => esc_attr__( 'Remove', 'baklon' ),
				'default'              => esc_attr__( 'Default', 'baklon' ),
				'selectFile'           => esc_attr__( 'Select File', 'baklon' ),
				'standardFonts'        => esc_attr__( 'Standard Fonts', 'baklon' ),
				'googleFonts'          => esc_attr__( 'Google Fonts', 'baklon' ),
				'defaultCSSValues'     => esc_attr__( 'CSS Defaults', 'baklon' ),
				'defaultBrowserFamily' => esc_attr__( 'Default Browser Font-Family', 'baklon' ),
			)
		);
