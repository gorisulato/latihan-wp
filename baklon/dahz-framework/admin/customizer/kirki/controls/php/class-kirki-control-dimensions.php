...
class Kirki_Control_Dimensions extends Kirki_Control_Base {
	...
	protected function l10n() {
		return array(
			...
			'font-size'      => esc_attr__( 'Font Size', 'baklon' ),
			'font-weight'    => esc_attr__( 'Font Weight', 'baklon' ),
			'line-height'    => esc_attr__( 'Line Height', 'baklon' ),
			'font-style'     => esc_attr__( 'Font Style', 'baklon' ),
			'letter-spacing' => esc_attr__( 'Letter Spacing', 'baklon' ),
			'word-spacing'   => esc_attr__( 'Word Spacing', 'baklon' ),
			'top'            => esc_attr__( 'Top', 'baklon' ),
			'bottom'         => esc_attr__( 'Bottom', 'baklon' ),
			'left'           => esc_attr__( 'Left', 'baklon' ),
			'right'          => esc_attr__( 'Right', 'baklon' ),
			'center'         => esc_attr__( 'Center', 'baklon' ),
			'size'           => esc_attr__( 'Size', 'baklon' ),
			'height'         => esc_attr__( 'Height', 'baklon' ),
			'spacing'        => esc_attr__( 'Spacing', 'baklon' ),
			'width'          => esc_attr__( 'Width', 'baklon' ),
			'height'         => esc_attr__( 'Height', 'baklon' ),
			'invalid-value'  => esc_attr__( 'Invalid Value', 'baklon' ),
		);
	}
}
