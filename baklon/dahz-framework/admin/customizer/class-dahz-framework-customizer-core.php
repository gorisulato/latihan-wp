		...
		public function dahz_framework_general() {
			...
			/* Custom Code Control Start */
				...
				$merge_scripts[] = array(
					...
					'label'			=> esc_html__( 'Enable Scripts Merger', 'baklon' ),
					'description'	=> esc_html__( 'Merge / Concatenate & Minify CSS & JS', 'baklon' ),
					'default'		=> '1',
					'priority'		=> 10,
				);
				...
				$custom_code[]	= array(
					'type'			=> 'code',
					'settings'		=> 'css',
					'label'			=> esc_html__( 'Custom Code CSS', 'baklon' ),
					'description'	=> esc_html__( 'Quickly add custom CSS to your site without any complicated setups. Ideal for minor style alterations or small snippets. Do not place any style tags in these areas as they are already added for your convenience.', 'baklon' ),
					'default'		=> '',
					'priority'		=> 10,
					'choices'		=> array(
						'language'	=> 'css',
				...
				$custom_code[]	= array(
					'type'			=> 'code',
					'settings'		=> 'js_header',
					'label'			=> esc_html__( 'Custom Code JS Header', 'baklon' ),
					'description'	=> esc_html__( 'Quickly add custom JavaScript to your site without any complicated setups. Ideal for minor style alterations or small snippets. Do not place any script tags in these areas as they are already added for your convenience.', 'baklon' ),
					'default'		=> '',
					'priority'		=> 10,
					'choices'		=> array(
						'language'	=> 'css',
				...
				$custom_code[]	= array(
					'type'			=> 'code',
					'settings'		=> 'js_footer',
					'label'			=> esc_html__( 'Custom Code JS Footer', 'baklon' ),
					'description'	=> esc_html__( 'Quickly add custom JavaScript to your site without any complicated setups. Ideal for minor style alterations or small snippets. Do not place any script tags in these areas as they are already added for your convenience.', 'baklon' ),
					'default'		=> '',
					'priority'		=> 10,
					'choices'		=> array(
			...
			/* Custom Code Init Start */
				...
				$this->dahz_framework_add_section_customizer(
					'custom_code',
					array( 'title' => esc_html__( 'Custom Code', 'baklon' ), 'priority' => 9 ),
					$custom_code,
					'general'
				);
				$this->dahz_framework_add_section_customizer(
					'merge_scripts',
					array( 'title' => esc_html__( 'Merge Script', 'baklon' ), 'priority' => 8 ),
					$merge_scripts,
					'general'
				);
			...
			$this->dahz_framework_customizer_kirki_add_panel(
				'style',
				array(
					'title'			=> esc_html__( 'Style', 'baklon' ),
					'description'	=> esc_html__( 'Change Theme Style Options here.', 'baklon' ),
					'priority'		=> 5
				)
			);
			...
			$this->dahz_framework_customizer_kirki_add_panel(
				'general',
				array(
					'title'			=> esc_html__( 'General', 'baklon' ),
					'description'	=> esc_html__( 'Change Theme General Options here.', 'baklon' ),
					'priority'		=> 1
				)
			);
		...
		public function dahz_framework_header() {
			...
			/* Header Main Control Start */
				...
				$header_main[]	= array(
					...
					'label'				=> esc_html__( 'Header builder desktop', 'baklon' ),
					'default'			=> '',
					'priority'			=> 11,
				...
				$header_main[]	= array(
					...
					'label'				=> esc_html__( 'Header builder Desktop Preset Use', 'baklon' ),
					'default'			=> '',
					'priority'			=> 11,
					'partial_refresh'	=> array(
				...
				$header_main[]	= array(
					...
					'label'				=> esc_html__( 'Header builder Desktop is Preset Use', 'baklon' ),
					'default'			=> '',
					'priority'			=> 11,
					'partial_refresh'	=> array(
				...
				$header_main[]	= array(
					...
					'label'				=> esc_html__( 'Header builder desktop Edit', 'baklon' ),
					'default'			=> '',
					'priority'			=> 11,
					'partial_refresh'	=> array(
			...
			/* Header Mobile Main Control Start */
				...
				$headermobile_main[] = array(
					...
					'label'				=> esc_html__( 'Header builder mobile', 'baklon' ),
					'default'			=> '',
					'priority'			=> 11,
					'partial_refresh'	=> array(
				...
				$headermobile_main[] = array(
					...
					'label'				=> esc_html__( 'Header builder Mobile Preset Use', 'baklon' ),
					'default'			=> '',
					'priority'			=> 11,
					'partial_refresh'	=> array(
				...
				$headermobile_main[] = array(
					...
					'label'				=> esc_html__( 'Header builder Mobile is Preset Use', 'baklon' ),
					'default'			=> '',
					'priority'			=> 11,
					'partial_refresh'	=> array(
				...
				$headermobile_main[]	= array(
					...
					'label'				=> esc_html__( 'Header builder mobile Edit', 'baklon' ),
					'default'			=> '',
					'priority'			=> 11,
					'partial_refresh'	=> array(
			...
			/* Header Mobile Main Control End */
				...
				$logo_and_site[] = array(
					...
					'label'				=> '',
					'default'			=> '<div class="de-customizer-title">'. esc_html__( 'Default Logo', 'baklon' ) .'</div>',
					'priority'			=> 12,
				...
				$logo_and_site[] = array(
					...
					'label'				=> esc_html__( 'Upload Logo', 'baklon' ),
				...
				$logo_and_site[] = array(
					...
					'label'				=> esc_html__( 'Upload Retina Logo', 'baklon' ),
				...
				$logo_and_site[] = array(
					...
					'label'				=> '',
					'default'			=> '<div class="de-customizer-title">'. esc_html__( 'Site Icon', 'baklon' ) .'</div>',
					'priority'			=> 16,
				);
				$logo_and_site[] = array(
					'type'				=> 'select',
					'settings'			=> 'header_style',
					'label'				=> esc_html__( 'Header Style', 'baklon' ),
					'description'		=> esc_html__( 'Select your style of header', 'baklon' ),
					'default'			=> 'horizontal',
					'priority'			=> 11,
					'choices'			=> array(
			...
			/* Header Before and After Control Start */
				...
				$header_before_after[] = array(
					...
					'label'		=> esc_html__( 'Before Header', 'baklon' ),
					'default'	=> '',
					'priority'	=> 11,
				);
				$header_before_after[] = array(
					...
					'label'		=> esc_html__( 'After Header', 'baklon' ),
					'default'	=> '',
					'priority'	=> 11,
				);
			...
			/* Header Section Control Start */
				...
				$header_section[]	= array(
					...
					'label'		=> esc_html__( 'Element Color', 'baklon' ),
					'default'	=> array(
						'link'	=> '#333',
						'hover'	=> '#999',
					),
					...
					'transport'	=> 'postMessage',
					'choices'	=> array(
						'link'	=> esc_attr__( 'Default Color', 'baklon' ),
						'hover'	=> esc_attr__( 'Hover Color', 'baklon' ),
					),
				);
				...
				$header_section[]	= array(
					...
					'label'		=> esc_html__( 'Section Height', 'baklon' ),
					'priority'	=> 11,
					'default'	=> '80',
					'choices'	=> array(
									'min'  => '0',
				...
				$header_section[]	= array(
					...
					'label'		=> esc_html__( 'Section Sticky Height', 'baklon' ),
					'priority'	=> 11,
					'default'	=> '80',
					'choices'	=> array(
									'min'  => '0',
				...
				$header_section[]	= array(
					...
					'label'		=> esc_html__( 'Section Mobile Height', 'baklon' ),
					'priority'	=> 11,
					'default'	=> '80',
					'choices'	=> array(
									'min'  => '0',
				...
				$header_section[]	= array(
					...
					'label'		=> esc_html__( 'Section Border: Bottom', 'baklon' ),
					'priority'	=> 11,
					'default'	=> 0,
					'choices'	=> array(
									'min'  => '0',
				...
				$header_section[]	= array(
					...
					'label'		=> esc_html__( 'Border Color', 'baklon' ),
					'default'	=> '#ececec',
					'priority'	=> 11,
					'transport'	=> 'postMessage'
				);
				...
				$header_section[]	= array(
					...
					'label'		=> esc_html__( 'Section Border Style', 'baklon' ),
					'default'	=> 'solid',
					'priority'	=> 11,
					'transport'	=> 'postMessage',
					'choices'	=> array(
						'dotted'	=> esc_attr__( 'Dotted', 'baklon' ),
						'dashed'	=> esc_attr__( 'Dashed', 'baklon' ),
						'solid'		=> esc_attr__( 'Solid', 'baklon' ),
						'double'	=> esc_attr__( 'Double', 'baklon' ),
						'groove'	=> esc_attr__( 'Groove', 'baklon' ),
						'ridge'		=> esc_attr__( 'Ridge', 'baklon' ),
						'inset'		=> esc_attr__( 'Inset', 'baklon' ),
						'outset'	=> esc_attr__( 'Outset', 'baklon' ),
						'none'		=> esc_attr__( 'None', 'baklon' ),
						'hidden'	=> esc_attr__( 'Hidden', 'baklon' ),
					),
				);
			...
			/* Header Main Init Start */
				...
				$this->dahz_framework_add_section_customizer(
					'header_builder',
					array( 'title' => esc_html__( 'Header Builder', 'baklon' ), 'priority' => 1 ),
					$header_main,
					'header'
				);
			...
			/* Header Mobile Main Init Start */
				...
				$this->dahz_framework_add_section_customizer(
					...
					array( 'title' => esc_html__( 'Header Mobile Builder', 'baklon' ), 'priority' => 2 ),
					$headermobile_main,
					'header'
				);
			...
			/* Header Logo and Site Identity Init Start */
				...
				$this->dahz_framework_add_section_customizer(
					...
					array( 'title' => esc_html__( 'Logo & Site Identity', 'baklon' ), 'priority' => 3 ),
					$logo_and_site,
					'header'
				);
			...
			/* Header Before and After Init Start */
				...
				$this->dahz_framework_add_section_customizer(
					...
					esc_html__( 'Before & After Header', 'baklon' ),
					$header_before_after,
					'header'
				);
			...
			/* Header Section 1 Init Start */
				...
				$this->dahz_framework_add_section_customizer(
					'header_section1',
					array( 'title' => esc_html__( 'Header Section 1', 'baklon' ), 'priority' => 4 ),
					$header_section,
					'header'
				);
			...
			/* Header Section 2 Init Start */
				...
				$this->dahz_framework_add_section_customizer(
					'header_section2',
					array( 'title' => esc_html__( 'Header Section 2', 'baklon' ), 'priority' => 5 ),
					$header_section,
					'header'
				);
			...
			/* Header Section 3 Init Start */
				...
				$this->dahz_framework_add_section_customizer(
					'header_section3',
					array( 'title' => esc_html__( 'Header Section 3', 'baklon' ), 'priority' => 5 ),
					$header_section,
					'header'
				);
			...
			$this->dahz_framework_customizer_kirki_add_panel(
				'header',
				array(
					'title'			=> esc_html__( 'Header', 'baklon' ),
					'description'	=> esc_html__( 'Change Theme Header Options here.', 'baklon' ),
					'priority'		=> 2
				)
			);
		...
		public function dahz_framework_footer() {
			...
			/* Footer Main Control Start */
				...
				$footer_main[]	= array(
					'type'				=> 'textarea',
					'settings'			=> 'element_desktop',
					'label'				=> esc_html__( 'Footer builder Desktop', 'baklon' ),
					'default'			=> '',
					'priority'			=> 11,
					'partial_refresh'	=> array(
				...
				$footer_main[]	= array(
					'type'				=> 'text',
					'settings'			=> 'element_desktop_preset_used',
					'label'				=> esc_html__( 'Footer builder Desktop Preset Use', 'baklon' ),
					'default'			=> '',
					'priority'			=> 11,
					'partial_refresh'	=> array(
				...
				$footer_main[]	= array(
					'type'				=> 'checkbox',
					'settings'			=> 'element_desktop_is_use_preset',
					'label'				=> esc_html__( 'Footer builder Desktop is Preset Use', 'baklon' ),
					'default'			=> '',
					'priority'			=> 11,
					'partial_refresh'	=> array(
				...
				$footer_main[]	= array(
					'type'				=> 'textarea',
					'settings'			=> 'element_desktop_edit',
					'label'				=> esc_html__( 'Footer builder Desktop Edit', 'baklon' ),
					'default'			=> '',
					'priority'			=> 11,
					'partial_refresh'	=> array(
			...
			/* Footer General Control Start */
				...
				$footer_element[] = array(
					...
					'label'			=> esc_html__( 'Enable Fullwidth Footer', 'baklon' ),
					'description'	=> esc_html__( 'Enabling this feature, will make your footer wider, you can also add custom padding if this enable', 'baklon' ),
					'default'		=> '0',
					'priority'		=> 10,
				);
				// footer description
				$footer_section[]	= array(
					...
					'label'		=> '',
					'default'	=> '<div class="de-customizer-title">'. __( 'Footer Description & Copyright', 'baklon' ) .'</div>',
					'priority'	=> 11,
				);
				...
				$footer_element[] = array(
					...
					'label'			=> esc_html__( 'Description Title', 'baklon' ),
					'default'		=> '',
					'priority'		=> 11,
				);
				...
				$footer_element[] = array(
					...
					'label'			=> esc_html__( 'Footer Description', 'baklon' ),
					'description'	=> esc_html__( 'This will displayed on footer, if you put this element on footer builder', 'baklon' ),
					'default'		=> '',
					'priority'		=> 11,
				);
				$footer_element[]	= array(
					...
					'label'		=> esc_html__( 'Description Alignment', 'baklon' ),
					'default'	=> '',
					'priority'	=> 11,
					'choices'	=> array(
						'uk-text-left'		=> __( 'Left', 'baklon' ),
						'uk-text-center'	=> __( 'Center', 'baklon' ),
						'uk-text-right'		=> __( 'Right', 'baklon' )
					),
				);
				// footer site info
				...
				$footer_element[] = array(
					...
					'label'		=> esc_html__( 'Footer Site Info', 'baklon' ),
					'default'	=> __( '&#169;2018 Baklon - Election &amp; Political WordPress Theme', 'baklon' ),
					'priority'	=> 11,
				);
				...
				$footer_element[] = array(
					...
					'label'			=> esc_html__( 'Copyright Font Size', 'baklon' ),
					'default'		=> '16px',
					'priority'		=> 11,
				);
				...
				$footer_element[]	= array(
					...
					'label'		=> esc_html__( 'Copyright Alignment', 'baklon' ),
					'default'	=> '',
					'priority'	=> 11,
					'choices'	=> array(
						'uk-text-left'		=> __( 'Left', 'baklon' ),
			...
			/* Footer Before and After Control Start */
				...
				$footer_before_after[]	= array(
					...
					'label'		=> esc_html__( 'Before Footer Content Block', 'baklon' ),
					'default'	=> '',
					'priority'	=> 11,
				...
				$footer_before_after[]	= array(
					...
					'label'		=> esc_html__( 'After Footer Content Block', 'baklon' ),
					'default'	=> '',
					'priority'	=> 12,
					'choices'	=> dahz_framework_get_content_block(),
				);
			...
			/* Footer Section Control Start */
				...
				$footer_section[]	= array(
					...
					'settings'	=> 'custom_title_section_color',
					'label'		=> '',
					'default'	=> '<div class="de-customizer-title">'. __( 'Element Color', 'baklon' ) .'</div>',
					'priority'	=> 11,
				);
				// section color
				$footer_section[]	= array(
				...
				$footer_section[]	= array(
					...
					'label'		=> esc_html__( 'Footer Body Text Color', 'baklon' ),
					'default'	=> '#ececec',
					'priority'	=> 11,
					'transport'	=> 'postMessage'
				);
				...
				$footer_section[]	= array(
					...
					'label'		=> esc_html__( 'Footer Heading Text Color', 'baklon' ),
					'default'	=> '#ececec',
					'priority'	=> 11,
					'transport'	=> 'postMessage'
				);
				...
				$footer_section[]	= array(
					...
					'label'		=> esc_html__( 'Footer Extra Color', 'baklon' ),
					'default'	=> '#ececec',
					'priority'	=> 11,
					'transport'	=> 'postMessage'
				);
				...
				$footer_section[]	= array(
					...
					'label'		=> esc_html__( 'Footer Widget Title Color', 'baklon' ),
					'default'	=> '#ececec',
					'priority'	=> 11,
					'transport'	=> 'postMessage'
				);
				...
				$footer_section[]	= array(
					...
					'label'		=> esc_html__( 'Footer Divider Color', 'baklon' ),
					'default'	=> '#ececec',
					'priority'	=> 11,
					'transport'	=> 'postMessage'
				);
				...
				$footer_section[]	= array(
					...
					'label'		=> '',
					'default'	=> '<div class="de-customizer-title">'. __( 'Spacing', 'baklon' ) .'</div>',
					'priority'	=> 11,
				);
				...
				$footer_section[]	= array(
					...
					'label'		=> esc_html__( 'Section Padding: Top', 'baklon' ),
					'default'	=> '60',
					'priority'	=> 11,
					'choices'	=> array(
						'min'	=> '0',
				...
				$footer_section[]	= array(
					...
					'label'		=> esc_html__( 'Section Padding: Bottom', 'baklon' ),
					'default'	=> '40',
					'priority'	=> 11,
					'choices'	=> array(
						'min'	=> '0',
				...
				$footer_section[]	= array(
					...
					'label'		=> esc_html__( 'Section Border: Top', 'baklon' ),
					'default'	=> '0',
					'priority'	=> 11,
					'choices'	=> array(
						'min'	=> '0',
				...
				$footer_section[]	= array(
					...
					'label'		=> '',
					'default'	=> '<div class="de-customizer-title">'. __( 'Section Toggle', 'baklon' ) .'</div>',
					'priority'	=> 11,
				);
				...
				$footer_section[] = array(
					...
					'label'			=> esc_html__( 'Enable Section Toggle on Mobile', 'baklon' ),
					'description'	=> esc_html__( 'Enabling this feature, will make your footer toggle', 'baklon' ),
					'default'		=> '0',
					'priority'		=> 11,
				);
				...
				$footer_section[] = array(
					...
					'label'		=> esc_html__( 'Section Title on Mobile', 'baklon' ),
					'default'	=> '',
					'priority'	=> 11,
				);
			...
			/* Footer Main Init Start */
				...
				$this->dahz_framework_add_section_customizer(
					'footer_builder',
					array( 'title' => esc_html__( 'Footer Builder', 'baklon' ), 'priority' => 1 ),
					$footer_main,
					'footer'
				);
			...
			/* Footer General Init Start */
				...
				$this->dahz_framework_add_section_customizer(
					'footer_element',
					array( 'title' => esc_html__( 'Footer Element', 'baklon' ), 'priority' => 2 ),
					$footer_element,
					'footer'
				);
			...
			/* Footer Before and After Init Start */
				...
				$this->dahz_framework_add_section_customizer(
					...
					array( 'title' => esc_html__( 'Before and After Footer', 'baklon' ), 'priority' => 6 ),
					$footer_before_after,
					'footer'
				);
			...
			/* Footer Section 1 Init Start */
				...
				$this->dahz_framework_add_section_customizer(
					'footer_section1',
					array( 'title' => esc_html__( 'Footer Section 1', 'baklon' ), 'priority' => 3 ),
					$footer_section,
					'footer'
				);
			...
			/* Footer Section 2 Init Start */
				...
				$this->dahz_framework_add_section_customizer(
					'footer_section2',
					array( 'title' => esc_html__( 'Footer Section 2', 'baklon' ), 'priority' => 4 ),
					$footer_section,
					'footer'
				);
			...
			/* Footer Section 3 Init Start */
				...
				$this->dahz_framework_add_section_customizer(
					'footer_section3',
					array( 'title' => esc_html__( 'Footer Section 3', 'baklon' ), 'priority' => 5 ),
					$footer_section,
					'footer'
				);
			...
			$this->dahz_framework_customizer_kirki_add_panel(
				'footer',
				array(
					'title'			=> esc_html__( 'Footer', 'baklon' ),
					'description'	=> esc_html__( 'Change Theme Footer Options here.', 'baklon' ),
					'priority'		=> 3
				)
			);
		...
		public function dahz_framework_page() {
			...
			/* Page Control Start */
				...
				$page[]	= array(
					'type'		=> 'radio-image',
					'settings'	=> 'layout',
					'label'		=> esc_html__( 'Sidebar Layout', 'baklon' ),
					'default'	=> 'full',
					'priority'	=> 11,
					'choices'	=> array(
			...
			$this->dahz_framework_customizer_kirki_add_panel(
				'page',
				array(
					'title'       => esc_html__( 'Page', 'baklon' ),
					'description' => esc_html__( 'Change Theme Page Options here.', 'baklon' ),
					'priority'	  => 8
				)
			);
		}
		...
		public function dahz_framework_blog() {
			...
			/* Blog Control Start */
				...
				$blog[]	= array(
					'type'		=> 'radio',
					'settings'	=> 'layout',
					'label'		=> esc_html__( 'Post Layout', 'baklon' ),
					'default'	=> 'full_width',
					'priority'	=> 10,
					'choices'	=> array(
						'full_width'	=> esc_attr__( 'Fullwidth', 'baklon' ),
						'left_sidebar'	=> esc_attr__( 'Left Sidebar', 'baklon' ),
						'right_sidebar'	=> esc_attr__( 'Right Sidebar', 'baklon' ),
					),
				);
			...
			$this->dahz_framework_customizer_kirki_add_panel(
				'blog',
				array(
					'title'       => esc_html__( 'Blog', 'baklon' ),
					'description' => esc_html__( 'Change Theme Blog Options here.', 'baklon' ),
					'priority'	  => 6
				)
			);
		...
		*/
		public function dahz_framework_woo() {
			...
			$this->dahz_framework_customizer_kirki_add_panel(
				'woocommerce',
				array(
					'title'       => esc_html__( 'Woocommerce', 'baklon' ),
					'description' => esc_html__( 'Change Theme Woocommerce Options here.', 'baklon' ),
					'priority'    => 9,
				)
			);
		...
		*/
		public function dahz_framework_export_import() {
			...
			$this->dahz_framework_customizer_kirki_add_panel(
				'backup',
				array(
					'title'       => esc_html__( 'Backup', 'baklon' ),
					'description' => '',
					'priority'    => 11,
				)
			);
			...
			$export_import[] = array(
				...
				'label'		=> esc_html__( 'Export Import', 'baklon' ),
				'default'	=> '',
			);
			...
			$export_import[] = array(
				...
				'label'		=> esc_html__( 'Export Color Scheme', 'baklon' ),
				'default'	=> '',
			);
			...
			$this->dahz_framework_add_section_customizer(
				'export_import',
				array( 'title' => esc_html__( 'Export Import', 'baklon' ), 'priority' => 999 ),
				$export_import,
				'backup'
			);
			...
			$this->dahz_framework_add_section_customizer(
				'header_backup',
				array( 'title' => esc_html__( 'Header Backup', 'baklon' ), 'priority' => 999 ),
				$header_import,
				'backup'
			);
			...
			$this->dahz_framework_add_section_customizer(
				'footer_backup',
				array( 'title' => esc_html__( 'Footer Backup', 'baklon' ), 'priority' => 999 ),
				$footer_import,
				'backup'
			);
		...
		public function dahz_framework_import_customizer( $wp_customize, $is_import_preset = false, $preset_type = '' ) {
			...
			if ( ! $is_import_preset ) {
				...
				if ( ! file_exists( $file['file'] ) ) {
					$dahz_export_import_error = esc_html__( 'Error importing settings! Please try again.', 'baklon' );
					return;
				}
				...
				if ( 'array' != gettype( $data ) ) {
					$dahz_export_import_error = esc_html__( 'Error importing settings! Please check that you uploaded a customizer export file.', 'baklon' );
					return;
				}
				...
				if ( $data['template'] != $template ) {
					$dahz_export_import_error = esc_html__( 'Error importing settings! The settings you uploaded are not for the current theme.', 'baklon' );
					return;
				}
