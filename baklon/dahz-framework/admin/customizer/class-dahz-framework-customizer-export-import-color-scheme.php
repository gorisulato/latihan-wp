	...
	Class Dahz_Framework_Customizer_Export_Import_Color_Scheme extends WP_Customize_Control{
		...
		?>
			<div class="de-customizer-title">
				<?php esc_html_e( 'Export Color Scheme', 'baklon' ); ?>
			</div>
			<span class="description customize-control-description">
				<?php esc_html_e( 'Click the button below to export the customization settings for this theme.', 'baklon' ); ?>
			</span>
			<input type="button" class="button" name="dahz-customizer-export-color-scheme" value="<?php esc_attr_e( 'Export Color Scheme', 'baklon' ); ?>" />
		<?php
		}
