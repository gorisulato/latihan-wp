...
if( !class_exists( 'Dahz_Framework_Customizer' ) ){
	...
	abstract Class Dahz_Framework_Customizer{
		 ...
		 * @return void 
		 */
		public function dahz_framework_customizer_kirki_add_config( $config_id, $args = array() ) {
		 ...
		 * @return void 
		 */
		public function dahz_framework_customizer_kirki_add_panel( $id = '', $args = array() ) {
			if ( class_exists( 'Kirki' ) ) {
		 ...
		 * @return void 
		 */
		public function dahz_framework_customizer_kirki_add_section( $id, $args ) {
			if ( class_exists( 'Kirki' ) ) {
		 ...
		 * @return void 
		 */
		public function dahz_framework_add_section_customizer( $id, $title = "", $field = array(), $panel = null, $active_callback = '', $option = 'option' ){
		 ...
		 * @return void
		 */
		public function dahz_framework_add_field_customizer( $id, $field = array() ){
			if($field){
				foreach( $field as $section_field ){
					$section_field['section'] = $id;
					$section_field['settings'] = $id.'_'.$section_field['settings'];
		 ...
		 * @return void 
		 */
		public function dahz_framework_set_customize_property( $class, $property, $prefix ){
