	...
	Class Dahz_Framework_Preset_Export_Import_Header extends WP_Customize_Control{
		...
		?>
			...
			<div class="de-customizer-title">
				<?php esc_html_e( 'Export Header Preset', 'baklon' ); ?>
			</div>
			<span class="description customize-control-description">
				<?php esc_html_e( 'Click the button below to export the customization settings for this theme.', 'baklon' ); ?>
			</span>
			<input type="button" class="button" data-to-export="header-preset" name="dahz-preset-export" value="<?php esc_attr_e( 'Export Header Preset', 'baklon' ); ?>" />
			<div class="de-customizer-title">
				<?php esc_html_e( 'Import Header Preset', 'baklon' ); ?>
			</div>
			<span class="description customize-control-description">
			...
			<div class="dahz-header-preset-uploading"><?php esc_html_e( 'Please Wait ...', 'baklon' ); ?></div>
			<input type="button" class="button" data-to-export="header-preset" name="dahz-preset-import" value="<?php esc_attr_e( 'Import Header Preset', 'baklon' ); ?>" />
