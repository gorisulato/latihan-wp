			...
			class Dahz_Framework_Envato_Theme_Setup_Wizard extends Envato_Theme_Setup_Wizard {
				...
				public function theme_setup_wizard_steps($steps){
					...
					$steps['child_themes'] = array(
						'name'    => esc_html__( 'Child Themes', 'baklon' ),
				...
				public function dahz_framework_set_theme_mod_images(){
					...
					$mods_with_image_default = array(
						'page-title-min'	=> array(
							'blog_template_background_image',
							'blog_archive_background_image',
							'single_events_background_image',
							'archive_events_background_image',
							'archive_donations_background_image',
							'single_donations_background_image',
							'portfolio_archive_background_image',
							'shop_woo_home_page_background_image',
							'shop_woo_cat_background_image',
							'shop_woo_brand_background_image'
						),
				...
				public function dahz_framework_make_child_theme( $new_theme_title ) {
					...
					$parent_theme_title = 'baklon';
					$parent_theme_template = 'baklon';
					...
					if($parent_theme_template !== $new_theme_name){
						...
						update_option( 'baklon_child_theme', $new_theme_name, 'no' );
