<?php
/**
* 1. dahz_framework_set_customize_options
* set value to global variable $dahz_framework
* @param - $property, $object_id
* @return -
*/
...
/**
* 2. dahz_framework_register_customizer
* -
* @param - $class, $options, $default
* @return -
*/
...
/**
* 3. dahz_framework_get_builder_items
* register element to customizer
* @param - $builder_type
...
/**
* 4. dahz_framework_customize_render_builder_items
* render list of element customizer builder & element storage &
* setting element callback to its section
* @param - $builder_type
* @return -
*/
...
/**
* 5. dahz_framework_customize_render_builder_item
* render per element on customizer builder & element storage
* @param - $builder_type
* @return -
*/
if( !function_exists( 'dahz_framework_customize_render_builder_item' ) ){
	...
	?>
		<span data-item="<?php echo esc_attr( $item_id );?>" data-section="<?php echo esc_attr( $section_callback );?>" class="de-<?php echo esc_attr( $builder_type );?>-items de-custom-<?php echo esc_attr( $builder_type );?>__element-item" >
			<span class="de-custom-<?php echo esc_attr( $builder_type );?>__element-name"><?php printf( esc_html__( '%s', 'baklon' ), $title ) ; ?></span>
			<span class="de-custom-<?php echo esc_attr( $builder_type );?>__element-description"><?php printf( esc_html( '%s', 'baklon' ), $description ); ?></span>
		</span>
...
/**
* 6. dahz_framework_render_builder_items
* get buffer rendered element
* @param - $available_items, $content
* @return - dahz_framework_get_buffer_html( $args );
*/
...
/**
* 7. dahz_framework_get_template_part
* -
* @param - $slug, $name
* @return -
*/
...
/**
* 8. dahz_framework_locate_template
* -
...
/**
* 10. dahz_framework_get_template_html
...
/**
* 11. dahz_framework_get_buffer_html
* buffer rendered element
* @param - $function
* @return - $html
*/
...
/**
* 20. dahz_framework_get_content_block
* render content block post
* @param -
* @return -
*/
if( !function_exists( 'dahz_framework_get_content_block') ){
	...
	function dahz_framework_get_content_block( $inherit = false ){
		...
		if( !class_exists('DahzExtender_Content_Blocks') ) return array( '' => esc_html__( 'empty', 'baklon' ) );
...
/**
* 21. dahz_framework_get_portfolio
* render content block post
* @param -
* @return -
*/
...
/**
* 21. dahz_framework_get_builder_presets_option
* get list of builder customizer user presets for admin select box
* @param -
* @return -
*/
if( !function_exists( 'dahz_framework_get_builder_presets_option') ){
	...
	function dahz_framework_get_builder_presets_option( $builder_type, $is_default = false ){
		...
		$customize_builder_presets[''] = esc_html__( 'Inherit', 'baklon' );
		
		if( $builder_type == 'footer' ){
			
			$customize_builder_presets['disable'] = esc_html__( 'Disable Footer', 'baklon' );
		...
		if( !empty( $customize_presets ) ){
			...
			foreach( $customize_presets as $id => $value ){
				...
				$customize_builder_presets[$id] = __( "Preset", 'baklon' ) . " : $id";
...
/**
* 22. dahz_framework_get_all_menu
* get list of menu on admin
* @param -
* @return -
*/
...
/**
* 23. dahz_framework_get_portfolio_category
* get list of category on custom post type portfolio
* @param -
* @return -
*/
...
function dahz_framework_default_preset_item( $presets, $builder_type ){
		...
		foreach( $presets as $name => $value ){
			...
			if( !in_array( $value['preset_category_id'], $current_preset_category ) ){
				...
				$preset_category .= sprintf(
					...
					sprintf( __( '%1$s', 'baklon' ), $value['preset_category_name'] )
				);
	...
	$preset .= sprintf(
		...
		',
		esc_attr( $builder_type ),
		esc_html__( 'All', 'baklon' ),
		esc_html__( 'Saved Preset', 'baklon' ),
		$preset_category
	);
...
/**
* dahz_framework_get_category_img_url
* return category img url from custom category image
* @param $term_id, $size, $placeholder
* @return void
*/
