			...
			return array(
				'modifier'	=> array(
					...
					'focus_border_style'	=> array(
						...
						'choices'		=> array(
							'none'			=> __( 'None', 'baklon' ),
							'solid'		=> __( 'Solid', 'baklon' ),
							'dashed'	=> __( 'Dashed', 'baklon' ),
							'dotted'	=> __( 'Dotted', 'baklon' ),
						)
					),
				),
				'size'	=> array(
				...
				'type'				=> array(
					...
					'font_weight'		=> array(
						...
						'default'		=> 'inherit',
						'choices'		=> array(
							'inherit'	=> __( 'Inherit', 'baklon' ),
							'normal'	=> __( 'Normal', 'baklon' ),
							'bold'		=> __( 'Bold', 'baklon' ),
						)
					),
					...
					'text_transform'	=> array(
						...
						'choices'		=> array(
							'inherit'		=> __( 'Inherit', 'baklon' ),
							'lowercase'		=> __( 'Lowercase', 'baklon' ),
							'uppercase'		=> __( 'Uppercase', 'baklon' ),
							'capitalize'	=> __( 'Capitalize', 'baklon' ),
						)
					),
					'icon_color'			=> array(
				...
				'global'			=> array(
					...
					'border_mode'		=> array(
						...
						'choices'		=> array(
							''			=> __( 'Full', 'baklon' ),
							'-top'		=> __( 'Top', 'baklon' ),
							'-right'	=> __( 'Right', 'baklon' ),
							'-bottom'	=> __( 'Bottom', 'baklon' ),
							'-left'		=> __( 'Left', 'baklon' ),
						)
					),
					'border_radius'		=> array(
