    ...
    dahz.stickyHeader = {
        ...
        init: function() {
            ...
            dahz.stickyHeader.set({
				...
				top:$( '#de-header-horizontal-desktop .de-header__sticky--wrapper' ).data( 'header-sticky-top' )
            });
        ...
        sticky: function($el, type) {
            ...
            UIkit.sticky($el, {
                ...
                'top': ! dahz.stickyHeader.top ? ( ( $('#de-site-header').outerHeight() + dahz.stickyHeader.edgeY ) + ( $(window).outerHeight() ) ) : 0,
            ...
            if (!$container.data('mobile-menu-is-loaded')) {
                $.ajax({
                    ...
                    data: {
						...
						is_override: typeof dahzFramework.megamenu !== 'undefined' && dahzFramework.megamenu.isOverride ? true : false,
						page_id:typeof dahzFramework.megamenu !== 'undefined' && dahzFramework.megamenu.isOverride ? dahzFramework.megamenu.pageID : false,
                    },
                    success: function(data) {
