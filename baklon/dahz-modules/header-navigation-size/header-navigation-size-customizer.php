	...
	Class Dahz_Framework_Header_Navigation_Size_Customizer extends Dahz_Framework_Customizer_Extend{
		...
		public function dahz_framework_set_customizer(){
			...
			$dv_field[] = array(
				'type'        => 'dimension',
				'settings'    => 'primary',
				'label'       => esc_html__( 'Primary Nav Size', 'baklon' ),
				'description' => esc_html__('Set your main nav size (px)', 'baklon' ),
				'default'     => '16px',
				'priority'    => 11,
			...
			$dv_field[] = array(
				...
				'label'       => esc_html__( 'Primary Hover Style', 'baklon' ),
				'description' => esc_html__('Select the hover type for main navigation', 'baklon' ),
				'default'     => 'style-2',
				'priority'    => 11,
				'choices'     => array(
			...
			$dv_field[] = array(
				...
				'label'    => esc_html__( 'Enable Primary Uppercase Navigation', 'baklon' ),
				'default'  => '0',
				'priority' => 11,
				'partial_refresh' => array(
			...
			$dv_field[] = array(
				'type'        => 'dimension',
				'settings'    => 'secondary',
				'label'       => esc_html__( 'Secondary Nav Size', 'baklon' ),
				'description' => esc_html__('Set your secondary nav size (px)', 'baklon' ),
				'default'     => '16px',
				'priority'    => 11,
				'partial_refresh' => array(
			...
			$dv_field[] = array(
				...
				'label'       => esc_html__( 'Secondary Hover Style', 'baklon' ),
				'description' => esc_html__('Select the hover type for secondary navigation', 'baklon' ),
				'default'     => 'style-2',
				'priority'    => 11,
				'choices'     => array(
					'style-1' => get_template_directory_uri() . '/assets/images/customizer/df_nav-style-1.svg',
			...
			$dv_field[] = array(
				...
				'label'    => esc_html__( 'Enable Secondary Uppercase Navigation', 'baklon' ),
				'default'  => '0',
				'priority' => 11,
				'partial_refresh' => array(
