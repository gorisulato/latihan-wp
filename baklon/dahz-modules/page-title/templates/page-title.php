...
$title_class = ! empty( $title_class ) ? $title_class : '';
...
<div <?php dahz_framework_set_attributes(
	...
	<div class="de-page-title__container uk-container">
		<?php if( !empty( $title ) ): ?>
			<h1 class="<?php echo esc_attr( $title_class );?> uk-heading-primary"><?php echo apply_filters( 'dahz_framework_page_title_title_html', $title ); ?></h1>
		<?php endif; ?>
	...
	<?php if( !empty( $description ) && $layout == 'titania' ): ?>
		<a href="#page-subtitle" class="de-page-title__nav uk-icon-link" data-uk-icon="icon:arrow-down;ratio:2;" data-uk-scroll="<?php echo esc_attr( sprintf( 'offset: %s', $offset_adminbar ) ); ?>" aria-label="<?php esc_attr_e( 'Scroll down', 'baklon' ); ?>"></a>
	<?php endif; ?>
	...
	<div id="page-subtitle">
		<div class="de-page-subtitle uk-container">
			<div class="de-page-subtitle__container uk-margin-medium-top uk-child-width-1-2@m uk-grid" data-uk-grid>
				<div>
					<h2 class="<?php echo esc_attr( $title_class );?>"><?php echo apply_filters( 'dahz_framework_page_title_title_html', $title ); ?></h2>
				</div>
				<div>
					<?php echo apply_filters( 'dahz_framework_page_title_description_html', $description ); ?>
				</div>
