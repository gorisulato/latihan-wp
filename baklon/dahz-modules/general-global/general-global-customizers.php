	...
	Class Dahz_Framework_Modules_General_Global_Customizer extends Dahz_Framework_Customizer_Extend {
		...
		public function dahz_framework_set_customizer() {
			...
			$dv_field[] = array(
				...
				'label'		=> __( 'Disable Comment on Page', 'baklon' ),
				'default'	=> 'off',
				'choices'	=> array(
					'on'	=> __( 'On', 'baklon' ),
					'off'	=> __( 'Off', 'baklon' )
			...
			$dv_field[] = array(
				...
				'label'		=> __( 'Enable Sticky Sidebar', 'baklon' ),
				'default'	=> 'on',
				'choices'	=> array(
					'on'	=> __( 'On', 'baklon' ),
					'off'	=> __( 'Off', 'baklon' )
			...
			$dv_field[] = array(
				...
				'label'		=> __( 'Enable Back to Top', 'baklon' ),
				'default'	=> 'on',
				'choices'	=> array(
					'on'	=> __( 'On', 'baklon' ),
					'off'	=> __( 'Off', 'baklon' )
			...
			$dv_field[] = array(
				...
				'label'		=> __( 'Enable Uppercase Widget Title', 'baklon' ),
				'default'	=> 'off',
				'choices'	=> array(
					'on'	=> __( 'On', 'baklon' ),
					'off'	=> __( 'Off', 'baklon' )
