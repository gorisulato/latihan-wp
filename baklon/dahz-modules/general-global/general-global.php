	...
	Class Dahz_Framework_General_Global{
		...
		public function dahz_framework_general_global_init( $path ){
			...
			dahz_framework_register_customizer(
				...
				array(
					'id'	=> 'global',
					'title' => array( 'title' => esc_html__( 'Global', 'baklon' ), 'priority' => 1 ),
					'panel'	=> 'general'
				),
				array()
			);
			dahz_framework_register_customizer(
				...
				array(
					'id'	=> 'inverse',
					'title'	=> array( 'title' => esc_html__( 'Inverse', 'baklon' ), 'priority' => 2 ),
					'panel'	=> 'style'
				),
				array()
			);
			...
			dahz_framework_register_customizer(
				...
				array(
					'id'	=> 'form',
					'title' => array( 'title' => esc_html__( 'Form', 'baklon' ) ),
					'panel'	=> 'style'
				),
				array()
			);
			...
			dahz_framework_register_customizer(
				...
				array(
					'id'	=> 'color_button',
					'title'	=> array( 'title' => esc_html__( 'Button', 'baklon' ), 'priority' => 2 ),
					'panel'	=> 'style'
				),
				array()
			);
			...
			dahz_framework_register_customizer(
				...
				array(
					'id'	=> 'offcanvas',
					'title'	=> array( 'title' => esc_html__( 'Offcanvas', 'baklon' ), 'priority' => 3 ),
					'panel'	=> 'style'
				),
				array()
			);
