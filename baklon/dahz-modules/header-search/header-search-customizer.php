	...
	Class Dahz_Framework_Header_Search_Customizer extends Dahz_Framework_Customizer_Extend {
		...
		public function dahz_framework_set_customizer() {
			...
			$dv_field[] = array(
				'type'        => 'radio-image',
				'settings'    => 'style',
				'label'       => esc_html__( 'Search Style', 'baklon' ),
				'description' => esc_html__('Select type of search displayed on header', 'baklon' ),
			...
			$dv_field[] = array(
				...
				'label'    => esc_html__( 'Desktop text font size', 'baklon' ),
			...
			$dv_field[] = array(
				...
				'description'=> __( 'Set your text size(px) . Default is 18px', 'baklon' ),
				'label'    => esc_html__( 'Mobile text font size', 'baklon' ),
				'priority' => 11,
				'default'  => '18px',
				'partial_refresh' => array(
			...
			$dv_field[] = array(
				'type'     => 'multicheck',
				'settings' => 'post_type',
				'label'    => esc_html__( 'Search Query', 'baklon' ),
				'default'  => array( 'post', 'page' ),
				'priority' => 11,
				'choices'  => array(
					'product' 	=> esc_attr__( 'Product', 'baklon' ),
					'post' 		=> esc_attr__( 'Post', 'baklon' ),
					'portfolio' => esc_attr__( 'Portfolio', 'baklon' ),
					'page' 		=> esc_attr__( 'Page', 'baklon' )
				),
				'partial_refresh' => array(
