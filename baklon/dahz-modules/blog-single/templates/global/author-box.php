<div class="uk-width-1-1">
	...
	<div class="uk-grid" data-uk-grid>
		...
		<div class="de-single__author-box--inner-content-detail uk-width-5-6@m">
			<h6><?php esc_html_e( 'Published by', 'baklon' ) ?> <a href="<?php esc_url( $author_url ) ?>" class="uk-link-heading uk-link"><?php echo esc_html( $author_name ); ?></a></h6>
