...
if( !class_exists( 'Dahz_Framework_Header_Mobile' ) ){
	...
	Class Dahz_Framework_Header_Mobile {
	    ...
	    public function __construct(){
			...
			add_action( 'wp_ajax_dahz_framework_render_mobile_menu_elements', array( $this, 'dahz_framework_render_lazy_mobile_menu_elements' ), 10 );

			add_action( 'wp_ajax_nopriv_dahz_framework_render_mobile_menu_elements', array( $this, 'dahz_framework_render_lazy_mobile_menu_elements' ), 10 );
		...
		public function dahz_framework_header_mobile_init( $path ){
			...
			dahz_framework_register_customizer(
				...
				array(
					'id'	=> 'mobile_header',
					'title'	=> array( 'title' => esc_html__( 'Mobile Element', 'baklon' ), 'priority' => 16 ),
					'panel'	=> 'header'
				),
				array()
			);
		...
		public function dahz_framework_header_mobile_elements( $items ) {
			...
			$items['mobile_menu_content_block'] = array(
				'title'				=> esc_html__( 'Content Block', 'baklon' ),
				'description'		=> esc_html__( 'Display content block on menu mobile', 'baklon' ),
			...
			$items['secondary_menu'] = array(
				'title'				=> esc_html__( 'Secondary Menu', 'baklon' ),
				'description'		=> esc_html__( 'Secondary Menu Description', 'baklon' ),
			...
			$items['separator_1'] = array(
				'title'				=> esc_html__( 'Separator 1', 'baklon' ),
				'description'		=> esc_html__( 'Separator 1', 'baklon' ),
			...
			$items['separator_2'] = array(
				'title'				=> esc_html__( 'Separator 2', 'baklon' ),
				'description'		=> esc_html__( 'Separator 2', 'baklon' ),
				'render_callback'	=> array( $this, 'dahz_framework_separator' ),
				'section_callback'	=> 'mobile_header',
				'is_repeatable'		=> false,
				'is_lazyload'		=> false
			...
			$items['separator_3'] = array(
				'title'				=> esc_html__( 'Separator 3', 'baklon' ),
				'description'		=> esc_html__( 'Separator 3', 'baklon' ),
				'render_callback'	=> array( $this, 'dahz_framework_separator' ),
				'section_callback'	=> 'mobile_header',
				'is_repeatable'		=> false,
				'is_lazyload'		=> false
			...
			$items['separator_4'] = array(
				'title'				=> esc_html__( 'Separator 4', 'baklon' ),
				'description'		=> esc_html__( 'Separator 4', 'baklon' ),
				'render_callback'	=> array( $this, 'dahz_framework_separator' ),
				'section_callback'	=> 'mobile_header',
				'is_repeatable'		=> false,
				'is_lazyload'		=> false
			...
			$items['separator_5'] = array(
				'title'				=> esc_html__( 'Separator 5', 'baklon' ),
				'description'		=> esc_html__( 'Separator 5', 'baklon' ),
				'render_callback'	=> array( $this, 'dahz_framework_separator' ),
				'section_callback'	=> 'mobile_header',
				'is_repeatable'		=> false,
				'is_lazyload'		=> false
			...
			$items['separator_6'] = array(
				'title'				=> esc_html__( 'Separator 6', 'baklon' ),
				'description'		=> esc_html__( 'Separator 6', 'baklon' ),
				'render_callback'	=> array( $this, 'dahz_framework_separator' ),
				'section_callback'	=> 'mobile_header',
				'is_repeatable'		=> false,
				'is_lazyload'		=> false
        ...
        public function dahz_framework_header_lists( $items ){
            ...
            $items['mobile_header_element'] = array(
				'title'				=> esc_html__( 'Mobile Element', 'baklon' ),
				'description'		=> esc_html__( 'Display burger menu', 'baklon' ),
		...
		public function dahz_framework_mobile_element_style( $default_styles ){
			...
			$default_styles .= sprintf(
				...
				dahz_framework_get_option( 'mobile_header_logo_padding_top', '10' ),
				dahz_framework_get_option( 'mobile_header_logo_padding_bottom', '10' ),
		...
		public function dahz_framework_header_mobile_get_elements(){
			...
			echo sprintf(
				...
				__( 'Mobile Menu Button Open', 'baklon' )
			);
		...
		public function dahz_framework_render_mobile_menu_container() {
			...
			if ( isset( $dahz_framework->builder_items['mobile_header_element'] ) ) {
				...
				echo sprintf(
					...
					__( 'Mobile Menu Button Close', 'baklon' ),
					$this->dahz_framework_get_mobile_menu_elements()
				);
		...
		public function dahz_framework_render_lazy_mobile_menu_elements() {

			$this->dahz_framework_render_mobile_menu_elements();
		...
		public function dahz_framework_render_mobile_menu_elements() {
			...
			echo $this->dahz_framework_get_mobile_menu_elements();

		}
		
		public function dahz_framework_get_mobile_menu_elements() {
			...
			return apply_filters( 'dahz_framework_render_mobile_menu_elements', $elements, $mobile_header, $available_items );
