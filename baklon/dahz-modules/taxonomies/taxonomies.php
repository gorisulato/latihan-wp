		...
		public function dahz_framework_brand_categories_taxonomy_metabox( $dahz_meta ){
			...
			$dahz_meta->dahz_framework_metabox_add_field(
				array(
					'id'			=> 'categories',
					'type'			=> 'textfield',
					'title'			=> esc_html__( 'Type Product Categories Slug', 'baklon' ),
					'description'	=> esc_html__('Type product categories slug with "," separator', 'baklon' )
				)
			);
		...
		public function dahz_framework_taxonomy_metabox_image_thumbnail( $dahz_meta ){
			...
			$dahz_meta->dahz_framework_metabox_add_field(
				array(
					'id'			=> 'image_upload',
					'type'			=> 'image_uploader',
					'title'			=> esc_html__( 'Image Category Display', 'baklon' ),
					'description'	=> esc_html__('Select image pattern for Thumbnail', 'baklon' ),
				)
			);
