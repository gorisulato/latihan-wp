	...
	Class Dahz_Framework_Modules_General_Layout_Customizer extends Dahz_Framework_Customizer_Extend {
		...
		public function dahz_framework_set_customizer() {
			...
			$dv_field[] = array(
				...
				'label'		=> esc_html__( 'Layout', 'baklon' ),
				'default'	=> 'fullwidth',
				'choices'	=> array(
			...
			$dv_field[] = array(
				...
				'label'		=> __( 'Site Content Width (px)', 'baklon' ),
				'default'	=> '1200',
			);
			...
			$dv_field[] = array(
				...
				'label'		=> __( 'Site Boxed Width (px)', 'baklon' ),
				'default'	=> '1400',
			...
			$dv_field[] = array(
				...
				'label'		=> __( 'Framed Width (px)', 'baklon' ),
				'default'	=> '40',
				'active_callback'	=> array(
					array(
						'setting'	=> 'general_layout_general_layout',
			...
			$dv_field[] = array(
				...
				'type'		=> 'select',
				'settings'	=> 'box_shadow',
				'label'		=> esc_html__( 'Shadow Background', 'baklon' ),
				'default'	=> '',
				'choices'	=> array(
					''						=> __( 'None', 'baklon' ),
			...
			$dv_field[] = array(
				...
				'label'		=> __( 'Body Background Color', 'baklon' ),
				'default'	=> '#ffffff',
				'transport'	=> 'postMessage',
				'js_vars'	=> array(
					array(
			...
			$dv_field[] = array(
				...
				'label'			=> __( 'Body Background Image', 'baklon' ),
				'default'		=> '',
				'transport'		=> 'postMessage',
				'js_vars'		=> array(
					array(
			...
			$dv_field[] = array(
				...
				'label'		=> __( 'Background Size', 'baklon' ),
				'default'	=> 'cover',
				'choices'	=> array(
					'auto'		=> __( 'Auto', 'baklon' ),
			...
			$dv_field[] = array(
				...
				'label'		=> __( 'Background Repeat', 'baklon' ),
				'default'	=> 'no-repeat',
				'choices'	=> array(
			...
			$dv_field[] = array(
				...
				'label'		=> __( 'Background Position', 'baklon' ),
				'default'	=> 'left top',
				'choices'	=> array(
			...
			$dv_field[] = array(
				...
				'label'		=> __( 'Background Attachment', 'baklon' ),
				'default'	=> 'scroll',
				'choices'	=> array(
					'scroll'=> __( 'Scroll', 'baklon' ),
					'fixed'	=> __( 'Fixed', 'baklon' )
				),
				'transport'	=> 'postMessage',
				'js_vars'	=> array(
					array(
			...
			$dv_field[] = array(
				...
				'label'		=> __( 'Outer Background Color', 'baklon' ),
				'default'	=> '#f2f2f2',
				'active_callback'	=> array(
					array(
						'setting'	=> 'general_layout_general_layout',
			...
			$dv_field[] = array(
				...
				'label'		=> __( 'Outer Background Image', 'baklon' ),
				'section'	=> 'general_layout',
				'default'	=> '',
				'active_callback'	=> array(
					array(
