	...
	Class Dahz_Framework_Footer_Element {
		...
		public function dahz_framework_footer_element_init( $path ){
			...
			dahz_framework_register_customizer(
				...
				array(
					'id'	=> 'footer_element',
					'title' => esc_html__( 'Footer Element', 'baklon' ) ,
					'panel'	=> 'footer'
				),
				array()
			);
		...
		public function dahz_framework_footer_lists( $items ){
			...
			$items['payment_logo'] = array(
				'title'				=> esc_html__( 'Payment Logo', 'baklon' ),
				'description'		=> esc_html__( 'Display payment option', 'baklon' ),
			...
			$items['footer_logo'] = array(
				'title'				=> esc_html__( 'Footer Logo', 'baklon' ),
				'description'		=> esc_html__( 'Display Footer Logo', 'baklon' ),
		...
		public function dahz_framework_payment_logo() {
			...
			if( !empty( $image_normal ) || !empty( $image_retina ) ){
				...
				printf( '
					...
					esc_html__('Payment Logo', 'baklon' ),
					esc_url( $placeholder )
				);
