	...
	Class Dahz_Framework_Modules_General_404_Customizer extends Dahz_Framework_Customizer_Extend{
		...
		public function dahz_framework_set_customizer() {
			...
			$dv_field[] = array(
				'type'			=> 'image',
				'settings'		=> 'image_404',
				'label'			=> __( '404 Page', 'baklon' ),
				'description'	=> __( 'Upload image for 404 page', 'baklon' ),
				'help'			=> '',
			...
			$dv_field[] = array(
				...
				'label'		=> __( '404 Title', 'baklon' ),
				'default'	=> esc_attr__( 'Woopsie Daisy!' , 'baklon' ),
			...
			$dv_field[] = array(
				...
				'label'		=> __( 'Subtitle', 'baklon' ),
				'default'	=> esc_attr__( 'Looks like something went completely wrong! but don\'t worry<br>It can happen to the best of us, and it just happened to you', 'baklon' ),
				'transport'	=> 'postMessage',
				'js_vars'	=> array(
					array(
			...
			$dv_field[] = array(
				...
				'label'		=> __( 'Back to Homepage Button', 'baklon' ),
				'default'	=> 'on',
				'choices'	=> array(
					'on'	=> __( 'On', 'baklon' ),
					'off'	=> __( 'Off', 'baklon' )
