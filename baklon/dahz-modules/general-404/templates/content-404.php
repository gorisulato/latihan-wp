...
<section class="error-404 not-found uk-width-1 uk-flex" data-uk-height-viewport="<?php echo esc_attr( $height_viewport_options );?>">
	<div class="error-404__wrapper uk-text-center uk-margin-auto uk-margin-auto-vertical">
		...
		<header class="page-header">
			...
			<?php else:?>
				<h1 class="page-title"><?php esc_html_e( 'Woopsie Daisy!', 'baklon' ); ?></h1>
			<?php endif;?>
		</header><!-- .page-header -->
		<div class="page-content">
			<p>
				...
				<?php else:?>
					<?php echo wp_kses_post( 'Looks like something went completely wrong! but don\'t worry<br/>It can happen to the best of us, and it just happened to you', 'baklon' ); ?>
				<?php endif;?>
			</p>
			<?php if( dahz_framework_get_option( 'notfound_enable_back_to_homepage', true ) ):?>
				<a class="uk-button uk-button-default" href="<?php echo esc_url( home_url( '/' ) ) ?>"><?php esc_html_e( 'Go To Homepage', 'baklon' );?></a>
			<?php endif;?>
		</div> <!-- .page-content -->
	</div>
</section> <!-- .error-404 -->