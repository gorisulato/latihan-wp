	...
	Class Dahz_Framework_Header_Cart_Customizer extends Dahz_Framework_Customizer_Extend{
		...
		public function dahz_framework_set_customizer(){
			...
			$dv_field[] = array(
				'type'        => 'select',
				'settings'    => 'display_as',
				'label'       => esc_html__( 'Display Cart as', 'baklon' ),
				'description' => esc_html__('select type of cart layout displayed on header', 'baklon' ),
				'default'     => 'as-sidebar',
				'priority'    => 11,
				'choices'     => array(
					'as-link'     => __( 'As Link', 'baklon' ),
					'as-dropdown' => __( 'Dropdown', 'baklon' ),
					'as-sidebar'  => __( 'Off Canvas', 'baklon' ),
				),
			...
			$dv_field[] = array(
				'type'        => 'radio-image',
				'settings'    => 'style',
				'label'       => esc_html__( 'Cart Style', 'baklon' ),
				'description' => esc_html__('Select cart style displayed on header', 'baklon' ),
				'default'     => 'style-3',
				'priority'    => 11,
				'choices'     => array(
			...
			$dv_field[] = array(
				...
				'label'    => esc_html__( 'Show total price on desktop', 'baklon' ),
				'default'  => '1',
				'priority' => 11,
				'partial_refresh' => array(
			...
			$dv_field[] = array(
				...
				'label'    => esc_html__( 'Show total price on mobile', 'baklon' ),
				'default'  => '0',
				'priority' => 11,
				'partial_refresh' => array(
			...
			$dv_field[] = array(
				...
				'label'      => __( 'Counter Text Color', 'baklon' ),
				'description'=> __( 'this option only for style 5,6,7', 'baklon' ),
				'default'    => '#ffffff',
				'priority'	 => 11,
			...
			$dv_field[] = array(
				...
				'label'      => __( 'Counter Background Color', 'baklon' ),
				'description'=> __( 'this option only for style 5,6,7', 'baklon' ),
				'default'    => '#ff0000',
				'priority'	 => 11,
				'transport'  => 'postMessage',
			...
			$dv_field[] = array(
				...
				'label'       => esc_html__( 'Content Block', 'baklon' ),
				'description' => esc_html__('Display a custom content, this element will be rendered after the cart (Display as link, not include) You can use a custom content block', 'baklon' ),
				'default'     => '',
				'priority'    => 11,
