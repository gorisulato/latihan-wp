...
<?php if ( ! WC()->cart->is_empty() ) : ?>
	...
	<div class="de-mini-cart__item-action-container">
		<p class="woocommerce-mini-cart__total total de-mini-cart__item-price"><strong><?php esc_html_e( 'Subtotal', 'baklon' ); ?>:</strong> <?php echo WC()->cart->get_cart_subtotal(); ?></p>
...
<?php else : ?>
	<div class="de-mini-cart__item-outer-container de-mini-cart__item-outer-container--empty">
		<p class="woocommerce-mini-cart__empty-message"><?php esc_html_e( 'No products in the cart.', 'baklon' ); ?></p>
	</div>
	<div class="de-mini-cart__item-action-container">
	</div>
	<div class="de-mini-cart__item-custom-content">
