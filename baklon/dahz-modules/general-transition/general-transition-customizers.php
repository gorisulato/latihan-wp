	...
	Class Dahz_Framework_Modules_General_Transition_Customizer extends Dahz_Framework_Customizer_Extend {
		...
		public function dahz_framework_set_customizer() {
			...
			$dv_field[] = array(
				...
				'label'		=> __( 'Enable Transitions', 'baklon' ),
				'default'	=> 'off',
				'choices'	=> array(
					'on'	=> __( 'On', 'baklon' ),
					'off'	=> __( 'Off', 'baklon' )
			...
			$dv_field[] = array(
				...
				'label'		=> esc_html__( 'Transitions Loader', 'baklon' ),
				'default'	=> 'loader-1',
				'choices'	=> array(
			...
			$dv_field[] = array(
				...
				'label'			=> __( 'Transition Image', 'baklon' ),
				'default'		=> '',
			...
			$dv_field[] = array(
				...
				'label'			=> __( 'Transition Image Width', 'baklon' ),
				'default'		=> '100px',
				'active_callback'	=> array(
					array(
						'setting'	=> 'general_transition_transitions_loader',
			...
			$dv_field[] = array(
				...
				'label'			=> __( 'Transition Image Height', 'baklon' ),
				'default'		=> '100px',
				'active_callback'	=> array(
					array(
						'setting'	=> 'general_transition_transitions_loader',
