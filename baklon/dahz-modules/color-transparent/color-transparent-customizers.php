	...
	Class Dahz_Framework_Modules_Color_Transparent_Customizer extends Dahz_Framework_Customizer_Extend {
		public function dahz_framework_set_customizer() {
			...
			$dv_field[] = array(
				...
				'label'     => __( 'Global Dark Color', 'baklon' ),
				'default'   => '#000000',
			...
			$dv_field[] = array(
				...
				'label'     => __( 'Divider Dark Color', 'baklon' ),
				'default'   => '#000000',
				'transport' => 'postMessage',
				'js_vars'   => array(
					array(
			...
			$dv_field[] = array(
				...
				'label'     => __( 'Dot Nav Dark Color', 'baklon' ),
				'default'   => '#000000',
				'transport' => 'postMessage',
				'js_vars'   => array(
					array(
			...
			$dv_field[] = array(
				...
				'label'     => __( 'Slide Nav Dark Color', 'baklon' ),
				'default'   => '#000000',
				'transport' => 'postMessage',
				'js_vars'   => array(
					array(
			...
			$dv_field[] = array(
				...
				'label'     => __( 'Global Light Color', 'baklon' ),
				'default'   => '#ffffff',
				'transport' => 'postMessage',
				'js_vars'   => array(
					array(
			...
			$dv_field[] = array(
				...
				'label'     => __( 'Divider Light Color', 'baklon' ),
				'default'   => '#ffffff',
				'transport' => 'postMessage',
				'js_vars'   => array(
					array(
			...
			$dv_field[] = array(
				...
				'label'     => __( 'Dot Nav Light Color', 'baklon' ),
				'default'   => '#ffffff',
				'transport' => 'postMessage',
				'js_vars'   => array(
					array(
			...
			$dv_field[] = array(
				...
				'label'     => __( 'Slide Nav Light Color', 'baklon' ),
				'default'   => '#ffffff',
				'transport' => 'postMessage',
				'js_vars'   => array(
					array(
