...
if ( !class_exists( 'Dahz_Framework_Woo' ) ) {
	...
	class Dahz_Framework_Woo {
		...
		function __construct(){
			...
			add_action( 'dahz_framework_module_woo_init', array( $this, 'dahz_framework_woo_shop_init' ) );
		...
		public function dahz_framework_woo_single_init( $path ){
			...
			dahz_framework_register_customizer(
				...
				array(
					'id'	=> 'single_woo',
					'title'	=> esc_html__( 'Single Product', 'baklon' ),
					'panel'	=> 'woocommerce',
				),
				array()
			);
		...
		public function dahz_framework_woo_shop_init( $path ) {
			...
			if ( is_customize_preview() ) dahz_framework_include( $path . '/functions/woo-shop-customizers.php' );

			dahz_framework_register_customizer(
				'Dahz_Framework_Modules_Woo_Shop_Customizer',
				array(
					'id'	=> 'shop_woo',
					'title'	=> esc_html__( 'Shop', 'baklon' ),
					'panel'	=> 'woocommerce',
				),
				array()
			);
		...
		public function dahz_framework_register_shop_widget_area() {
			register_sidebar( array(
				'name'			=> __( 'Shop Filter', 'baklon' ),
				'id'			=> 'shop-sidebar-1',
				'description'	=> __( 'Widgets in this area will ONLY be shown in the shop archive.', 'baklon' ),
