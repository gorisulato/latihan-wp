	...
	Class Dahz_Framework_Header_Wishlist_Customizer extends Dahz_Framework_Customizer_Extend{
		...
		public function dahz_framework_set_customizer(){
			...
			$dv_field[] = array(
				'type'        => 'radio-image',
				'settings'    => 'style',
				'label'       => esc_html__( 'Wishlist Style', 'baklon' ),
				'description' => esc_html__('Select type of wishlist style do you want to use', 'baklon' ),
				'default'     => 'style-3',
				'priority'    => 11,
				'choices'     => array(
			...
			$dv_field[] = array(
				...
				'label'    => esc_html__( 'Enable Uppercase Text', 'baklon' ),
				'default'  => '0',
				'priority' => 11,
				'partial_refresh' => array(
