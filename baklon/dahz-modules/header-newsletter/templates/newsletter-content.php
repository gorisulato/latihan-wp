...
<div class="uk-grid-match uk-height-large uk-grid" data-uk-grid>
	<div class="uk-width-2-3@m de-quickview-images">
		<div class="uk-position-relative uk-visible-toggle" data-uk-slideshow>
			...
			<a class="uk-position-center-left uk-position-small uk-hidden-hover" href="#" data-uk-slidenav-previous data-uk-slideshow-item="previous" aria-label="<?php esc_attr_e( 'Previous', 'baklon' ); ?>"></a>
			<a class="uk-position-center-right uk-position-small uk-hidden-hover" href="#" data-uk-slidenav-next data-uk-slideshow-item="next" aria-label="<?php esc_attr_e( 'Next', 'baklon' ); ?>"></a>
		</div>
	</div>
