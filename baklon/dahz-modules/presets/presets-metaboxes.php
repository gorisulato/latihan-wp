		...
		public function dahz_framework_footer_presets_metabox( &$dahz_meta, $section ){
			...
			$dahz_meta->dahz_framework_metabox_add_field(
				...
				array(
					...
					'type'			=> 'select',
					'title'			=> esc_html__( 'Footer Preset', 'baklon' ),
					'description'	=> esc_html__('Select your footer Preset, it based from footer builder you have been created before', 'baklon' ),
