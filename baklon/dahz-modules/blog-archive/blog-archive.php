	...
	Class Dahz_Framework_Blog_Archive {
		...
		public function dahz_framework_blog_archive_init( $path ) {
			...
			dahz_framework_register_customizer(
				...
				array(
					'id'	=> 'blog_archive',
					'title'	=> array( 'title' => esc_html__( 'Blog Archive', 'baklon' ), 'priority' => 2 ),
					'panel'	=> 'blog'
				),
				array()
			);
			...
			dahz_framework_register_customizer(
				...
				array(
					'id'	=> 'blog_template',
					'title'	=> array( 'title' => esc_html__( 'Blog Layout', 'baklon' ), 'priority' => 1 ),
					'panel'	=> 'blog'
				),
				array()
			);
		...
		public function dahz_framework_archive_style( $dv_default_styles ) {
			...
			//Get Button Primary Color For Sticky Icon
			$button_primary_color = dahz_framework_get_option( 'color_button_modifier_primary_background', '#e61937' );
			...
			$dv_default_styles .= sprintf(
				...
				$divider_color, # 4
				get_theme_mod( 'color_button_modifier_primary_background', '#e61937' ), #5
				get_theme_mod( 'color_button_modifier_primary_color', '#ffffff' ), #6
				get_theme_mod( 'color_button_modifier_primary_border', '#e61937' ) #7
