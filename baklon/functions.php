	...
	function dahz_framework_init_default_styles() {
		...
		for ( $i = 1; $i <= 3; $i++ ) {
			...
			$default_styles .= sprintf(
				...
				$header_bg_image, // 3
				dahz_framework_get_option( 'header_section' . $i . '_section_height', '80' ), // 4
				dahz_framework_get_option( 'header_section' . $i . '_section_mobile_height', '80' ), // 5
				dahz_framework_get_option( 'header_section' . $i . '_section_border_bottom', '0' ), // 6
				...
				$footer_bg_image, // 12
				dahz_framework_get_option( 'footer_section' . $i . '_section_padding_top', '12' ), // 13
				dahz_framework_get_option( 'footer_section' . $i . '_section_padding_bottom', '12' ), // 14
				dahz_framework_get_option( 'footer_section' . $i . '_section_border_top', '0' ), // 15
...
$dahz_framework->site_key = 'de-content--baklon';
